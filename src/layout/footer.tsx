  ...
  return (
    <footer className="bg-[#536028] py-10">
      <div className="max-w-300 mx-auto w-full px-6 flex flex-col gap-6">
        ...
        {/* Top Section */}
        <div className="flex flex-col md:flex-row gap-4 md:gap-12 md:items-center justify-between pb-8 md:pb-12 border-b border-white/40">
          <Image
            src="/logoWhite.svg"
            alt="logo"
            width={300}
          ...
          <h5 className="text-white/80 ">
            Connect With Us : +91 88883 222287 +21 23456 23455
          </h5>
        </div>
